...
**從 v0.1.20 開始**，Web UI 服務（端口 3000）內建完整的 RAS (Remote AI Service) API，**無需額外啟動任何服務**。
...
curl -X POST http://localhost:3000/api/v1/validate \
  ...
  -d '{"inputFormat": "docx", "outputFormat": "pdf"}'
```
...
ConvertX-CN 另外提供選用的 Rust API Server，支援 REST 和 GraphQL 兩種 API 介面。
