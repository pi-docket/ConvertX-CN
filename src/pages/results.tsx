...
function ResultsArticle({
  ...
  return (
    <article class="article">
      <div
        class="
        mb-4 flex flex-col items-start justify-between gap-4
      ...
      >
        ...
        <div
          ...
          sm:w-auto sm:flex-nowrap sm:gap-4
        "
        >
          <a
            style={files.length !== job.num_files ? "pointer-events: none;" : ""}
            class="
              flex flex-1 btn-secondary flex-row justify-center gap-2 text-sm text-contrast
          ...
          <a
            ...
            class="
              flex flex-1 btn-primary flex-row justify-center gap-2 text-sm text-contrast
              sm:flex-none sm:text-base
            "
            {...(files.length !== job.num_files ? { disabled: true, "aria-busy": "true" } : "")}
          >
          ...
          {files.map((file) => {
            ...
            return (
              <tr style="border-bottom: 1px solid var(--glass-divider);">
                ...
                <td
                  class="
                  table-cell-padding flex flex-row gap-3 px-2
                  sm:px-4
                "
                >
